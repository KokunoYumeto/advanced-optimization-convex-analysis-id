...
\end{equation}
Dengan demikian, tripel ADMM yang benar-benar diperbarui
melalui~\eqref{duality:eq:admm_algo} memenuhi
\[
    0\in\partial_y L_0(x_{k+1},y_{k+1},\lambda_{k+1}).
\]
Pembaruan bergantian tersebut pada umumnya tidak memberikan stasioneritas
terhadap $x$, karena submasalah $x$ masih memakai $y_k$. Hanya dalam skema
hipotetis yang meminimumkan $x$ dan $y$ secara bersama kondisi serupa diperoleh
terhadap $x$, sehingga tripel hasil pembaruan bersama itu memenuhi
stasioneritas primal penuh untuk $L_0$.
