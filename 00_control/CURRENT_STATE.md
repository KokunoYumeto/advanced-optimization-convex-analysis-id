...
- reader PDF `output/pdf/D90-PENN-05-metode-newton-dan-koreksi-id.pdf`: 2,691,780 bytes / 15 A4 pages / SHA-256 `427db2c5a4428dfbe222d7e1d4f5c5349d4f78484a8593c412328fe94a7353c6`.
...
MIT/Royer source bytes and teaching closure must be independently frozen in this lane before translation. The MIT semantic-source pilot has not started. The complete 18-unit learner route, original bridges, 36 mastery problems, solution repairs, labs, capstone, semantic HTML/EPUB, tagged PDF, and human/native-speaker Indonesian review remain open. No final-corpus claim is allowed.
