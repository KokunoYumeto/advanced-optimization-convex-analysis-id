...
The first complete MIT semantic-source block covers exact complete-notes PDF pages 2--5, *The Role of Convexity in Optimization*. The project-made English witness is 5,752 bytes, SHA-256 `a18aefa9e1ffa29d0a3cea21d0df34f05025cb7c2008ae57b5db44730c9d1f58`; the Indonesian Markdown source is 8,641 bytes, SHA-256 `2170dec12e707782c7677647f77ad8ee3360b282a8dbb9fb5620170106004bf3`. It accounts for 21 top-level items, 12 nested bullets, and two freestanding display formulas with exact page/item mappings. Three disclosed semantic corrections are `O015-MIT-SEM-0001`--`0003`.

The semantic HTML is 20,613 bytes, SHA-256 `fff4de952dd2cb208208e1cfb3bbc8fe8a64936ff5fdb532a23a92fb0dc6af8b`; the 3-page A4 PDF is 53,370 bytes, SHA-256 `bd03912f9d3fe6dbe7376577c7ca6e7ab5aee007dd33b51669cde1792644df58`. Two builds are byte-identical. Exact structural/formula validation, 1280-by-720 and 390-by-844 browser reflow, all-page 160-dpi visual inspection, terminology QA, and independent rereview pass with P1=0/P2=0/P3=0. The block has zero figures and admits no Athena byte. The PDF is searchable with `/Lang id-ID` but untagged; independent human/native-speaker Indonesian review remains unrecorded.

The deterministic backend contains 1,430 records, adding 130 exact MIT/Royer/pilot IDs to the 1,300-record incoming baseline. The added-ID set has SHA-256 `fa0e7d763e2c3eab68ac32fe935d777f3c688c5d59cc509d93416608726cfaf5`. JSONL is 1,036,556 bytes, SHA-256 `ebf44ca94323584e40b548ce36da560899e39a1e76ed2c993a0786b4ee7c4a2b`; lossless CSV is 1,244,072 bytes, SHA-256 `bc73abb3457cacc10423c1785a0db70a9007fdef8ac0a2be1de48d25d389fdf5`. Both the extension and independent validator pass repeated terminal cycles.

## Preserved optional companion

Admitted units are Habring Chapters 3--9 and Penn Chapters 3--5. Habring authority is immutable arXiv:2607.11664v1 under CC BY 4.0. Penn authority is Christopher Griffin's editable MATH 555 v1.0 LaTeX distribution, with Simon Miller and Douglas Mercer contributions, under CC BY-NC-SA 3.0 United States; the public v1.0.1 PDF is a correction witness only.

The first nine admitted reader PDFs through Penn Chapter 4 total 139 A4 pages and are already preserved publicly. Penn Chapter 5 is now fully admitted:
...
- wrapper `source/id-ID/D90-PENN-05-metode-newton-dan-koreksi-id.tex`: current working-tree 7,227 bytes / SHA-256 `7de8bc61dc3f59999ac6414df90ef6925d5a7d4665f79d71998c8f0e45839c14`;
- reader PDF `output/pdf/D90-PENN-05-metode-newton-dan-koreksi-id.pdf`: current working-tree 2,691,773 bytes / 15 A4 pages / SHA-256 `dad34c7cb363197da1ae87117b22b2dde21d6d183997745cd3ffff62245c0b96`.

The published ten-unit Zenodo checkpoint intentionally retains the earlier
byte identities for Penn Chapters 4 and 5 (`c0f283aa...` and `427db2c5...`).
The current descendants above contain the bounded terminology normalization
and are not silently substituted into that immutable historical release.

Chapter 5 preserves all 84 ordered environments, ten labels, five exercises, four exact vector figures, sole citation, reference closure, 35 displayed-formula surfaces, and every authority line in seven stable segments. Twelve determined events `O015-PENN-ADV-0038`--`0049` are integrated. Structural and open-computation checks pass twice; independent rereview closes P1=0/P2=0/P3=0; two deterministic builds are byte-identical; all 15 pages pass visual review. The PDF is searchable, A4, unencrypted, `/Lang id-ID`, and all 137 fonts expose Unicode maps; it remains untagged and has no recorded human/native-speaker Indonesian review. Five Maple/legacy listing inputs remain excluded and are replaced by separately registered original pseudocode.

The ten-unit companion backend passes repeated generation/validation cycles after the final architecture/rights refresh. It contains 1,283 records and 84 segments. JSONL: 942,447 bytes, SHA-256 `e57a457d20edfcf772f38f7dd9dfdd3368530d785bbf5b71179b90784b8130f9`; CSV: 1,129,757 bytes, SHA-256 `e2ca8f3b58dc74e208a579ff1b55997d0e5e202f49c2b018edce6358b7492c2f`. Chapter 5 contributes 155 records and terminal record-set SHA-256 `979ec311c13ac368e7950bb734d4240310dec154d3e8151b042ed82333cb78c8`. The 1,128-record baseline is unchanged apart from enumerated live-control binding refreshes.

The completed Penn Chapter 6 candidate remains preserved but unadmitted at `source/id-ID/penn-06-metode-arah-konjugat-id.tex`, SHA-256 `34eb660080014e20efae0fbae79fc8fc36b080279ae1d78b4282a724adfaa735`. Do not admit it, start Penn Chapter 7, delete it, or use it as the primary cursor without a later explicit decision.
