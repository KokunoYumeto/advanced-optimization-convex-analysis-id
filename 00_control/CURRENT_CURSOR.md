...
As of: 2026-08-21  
State: Chapters 3 and 4 admitted after independent audits; Chapter 5 is the active cursor
...
- Current completed source unit: `authority/habring/source-v1/projected_subgradient_method.tex`
- Current target unit: `source/id-ID/habring-04-metode-subgradien-terproyeksi-id.tex`
- Next source file: `authority/habring/source-v1/proximal_gradient.tex`
- Next unit title: Proximal-gradient methods
- Do not restart at preliminaries or convexity; those are admitted as prerequisites/overlap, not untranslated cursor gaps.

## Next actions

1. Translate Chapter 5 contiguously, preserving every definition, theorem, proof, figure, and prompt; validate proximal mappings, forward–backward iteration, and convergence examples in the open stack.
2. Continue through Habring Chapters 6–9 in source order, with independently authored assessments/solutions only where the source has a documented mastery gap.
