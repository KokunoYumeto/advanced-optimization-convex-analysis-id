#!/usr/bin/env python3
"""Render and bind the final Original-01 PDF visual-QA evidence."""
...
BUILD_RECEIPT = ROOT / "qa" / "ORIGINAL_01_PDF_BUILD.json"
REPORT = ROOT / "qa" / "ORIGINAL_01_PDF_VISUAL_QA.json"
RENDER_DIR = ROOT / "tmp" / "pdfs" / "original-01-visual-qa"
...
def main() -> None:
    ...
    try:
        ...
        report = {
            "schema": "o015-original-01-pdf-visual-qa-v2",
            "date": "2026-08-26",
            "result": "pass",
            "artifact": {
                **record(PDF),
            ...
            "inspection": {
                ...
                "finding": (
                    "All 16 pages were inspected from 160-dpi renders. Typography, "
                    "equations, proofs, exercises, solutions, laboratory table, mixed-"
                    "rights notice, and accessibility note are legible and consistently "
                    "aligned. Numeric results remain available as text and CSV/JSON."
                ),
            },
            "repairs_bound": [
                "The accessibility note shares the rights page, eliminating the hollow tail page.",
