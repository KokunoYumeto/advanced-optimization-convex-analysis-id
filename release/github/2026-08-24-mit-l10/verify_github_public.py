#!/usr/bin/env python3
"""Anonymous exact-byte readback for a supplied MIT-L10 content commit.
...
USER_AGENT = "o015-l10-anonymous-public-readback"
...
def main() -> None:
    ...
    parser.add_argument("commit", help="exact 40-hex pushed L10 content commit")
    ...
    receipt = {
        ...
        "result": "pass",
        "schema": "o015-github-mit-l10-public-readback-v1",
        "scope": "MIT L10 complete Lecture 6 pages 64-85, exact reader/source/QA/backend/control and prepared Zenodo release bytes; page 86 is not claimed.",
        "tree": tree,
