#!/usr/bin/env python3
"""Anonymous exact-byte readback for one supplied MIT-L09 evidence commit."""
...
USER_AGENT = "o015-l09-evidence-anonymous-readback"
...
def main() -> None:
    ...
    receipt = {
        ...
        "result": "pass",
        "schema": "o015-github-mit-l09-evidence-public-readback-v1",
        "tree": tree,
