#!/usr/bin/env python3
"""Anonymous exact-byte readback for a supplied MIT-L09 content commit.

The commit, parent, and changed-file count are required arguments so this
template cannot bind a stale or invented Git identity.  Importing it performs
...
USER_AGENT = "o015-l09-anonymous-public-readback"
...
def main() -> None:
    ...
    parser.add_argument("commit", help="exact 40-hex pushed L09 content commit")
    ...
    receipt = {
        ...
        "result": "pass",
        "schema": "o015-github-mit-l09-public-readback-v1",
        "scope": "MIT L09 complete Lecture 5 pages 50-63, exact reader/source/QA/backend/control and prepared Zenodo release bytes; page 64 is not claimed.",
        "tree": tree,
