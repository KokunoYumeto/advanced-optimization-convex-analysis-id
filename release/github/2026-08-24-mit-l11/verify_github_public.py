#!/usr/bin/env python3
"""Anonymous exact-byte readback for a supplied MIT-L11 content commit.

The commit, parent, and changed-file count are required arguments so this
verifier cannot bind a stale or invented Git identity. Importing it performs
...
USER_AGENT = "o015-l11-anonymous-public-readback"
...
def main() -> None:
    ...
    parser.add_argument("commit", help="exact 40-hex pushed L11 content commit")
    parser.add_argument("parent", help="exact 40-hex expected parent commit")
    ...
    if parent != parent_expected:
        raise RuntimeError("supplied commit does not have the expected parent")
    paths = sorted(
        line
    ...
    receipt = {
        ...
        "result": "pass",
        "schema": "o015-github-mit-l11-public-readback-v1",
        "scope": "MIT L11 companion: complete Lecture 7 pages 86-97, exact reader/source/QA/backend/control and prepared Zenodo release bytes; page 98 is not claimed; Habring arXiv:2607.11664v1 remains the editable-source spine.",
        "tree": tree,
