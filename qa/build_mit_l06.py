#!/usr/bin/env python3
"""Build the MIT 6.253 complete-notes Lecture 2 boundary (PDF pages 20-28)."""
...
SOURCE = ROOT / "source/id-ID/mit-06-kuliah-2-landasan-konveks-id.md"
...
HTML_NAME = "D90-MIT-06-kuliah-2-landasan-konveks-id.html"
PDF_NAME = "D90-MIT-06-kuliah-2-landasan-konveks-id.pdf"
...
def main() -> None:
    ...
    if missing:
        raise FileNotFoundError(f"missing L06 build inputs: {missing}")
