#!/usr/bin/env python3
"""Build the MIT 6.253 complete-notes Lecture 6 boundary (PDF pages 64-85)."""
...
SOURCE = ROOT / "source/id-ID/mit-10-kuliah-6-irisan-tertutup-dan-hiperbidang-id.md"
...
HTML_NAME = "D90-MIT-10-kuliah-6-irisan-tertutup-dan-hiperbidang-id.html"
PDF_NAME = "D90-MIT-10-kuliah-6-irisan-tertutup-dan-hiperbidang-id.pdf"
...
def main() -> None:
    ...
    if missing:
        raise FileNotFoundError(f"missing L10 build inputs: {missing}")
