#!/usr/bin/env python3
"""Build the MIT 6.253 complete-notes Lecture 5 boundary (PDF pages 50-63)."""
...
SOURCE = ROOT / "source/id-ID/mit-09-kuliah-5-resesi-dan-minimum-id.md"
...
HTML_NAME = "D90-MIT-09-kuliah-5-resesi-dan-minimum-id.html"
PDF_NAME = "D90-MIT-09-kuliah-5-resesi-dan-minimum-id.pdf"
...
def main() -> None:
    ...
    if missing:
        raise FileNotFoundError(f"missing L09 build inputs: {missing}")
