#!/usr/bin/env python3
"""Build the MIT 6.253 complete-notes Lecture 3 boundary (PDF pages 29-38)."""
...
SOURCE = ROOT / "source/id-ID/mit-07-kuliah-3-fungsi-konveks-terdiferensial-caratheodory-id.md"
...
HTML_NAME = "D90-MIT-07-kuliah-3-fungsi-konveks-terdiferensial-caratheodory-id.html"
PDF_NAME = "D90-MIT-07-kuliah-3-fungsi-konveks-terdiferensial-caratheodory-id.pdf"
...
def main() -> None:
    ...
    if missing:
        raise FileNotFoundError(f"missing L07 build inputs: {missing}")
