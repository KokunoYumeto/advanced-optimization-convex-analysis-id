#!/usr/bin/env python3
"""Build the MIT complete-notes pages 16-19 course-orientation boundary."""
...
SOURCE = ROOT / "source/id-ID/mit-05-orientasi-kursus-id.md"
CSS = ROOT / "source/id-ID/mit-l05.css"
PREAMBLE = ROOT / "source/id-ID/mit-l05-preamble.tex"
PDF_FILTER = ROOT / "source/id-ID/mit-l03-pdf-filter.lua"
BEFORE_BODY = ROOT / "source/id-ID/mit-l05-before-body.html"
AFTER_BODY = ROOT / "source/id-ID/mit-l03-after-body.html"
HTML_NAME = "D90-MIT-05-orientasi-kursus-id.html"
PDF_NAME = "D90-MIT-05-orientasi-kursus-id.pdf"
