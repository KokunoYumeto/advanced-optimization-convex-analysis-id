#!/usr/bin/env python3
"""Build the MIT 6.253 complete-notes Lecture 7 boundary (PDF pages 86-97)."""
...
SOURCE = ROOT / "source/id-ID/mit-11-kuliah-7-pemisahan-dan-konjugasi-id.md"
...
HTML_NAME = "D90-MIT-11-kuliah-7-pemisahan-dan-konjugasi-id.html"
PDF_NAME = "D90-MIT-11-kuliah-7-pemisahan-dan-konjugasi-id.pdf"
...
def main() -> None:
    ...
    if missing:
        raise FileNotFoundError(f"missing L11 build inputs: {missing}")
